...
mutual
  ...
  oidvmap voidv      = refl⁼ 
  oidvmap < v , w >v = resp2 <_,_>v (oidvmap v) (oidvmap w) 
  ...
  oidnevmap (fstV n)   = resp fstV (oidnevmap n) 
  oidnevmap (sndV n)   = resp sndV (oidnevmap n) 
...
mutual
  ...
  compvmap f g < v , w >v = resp2 <_,_>v (compvmap f g v) (compvmap f g w)  
  ...
  compnevmap f g (fstV n)   = resp fstV (compnevmap f g n) 
  compnevmap f g (sndV n)   = resp sndV (compnevmap f g n) 
